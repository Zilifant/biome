> **⚠ Superseded by [`HANDOFF.md`](HANDOFF.md)** (2026-07-28 session), itself since
> superseded — the last handoff in this series is
> [`HANDOFF-2026-08-06.md`](HANDOFF-2026-08-06.md), and all of them are retired:
> current state is [`DOCS.md`](../DOCS.md) and open work is
> [`ACTION-ITEMS.md`](../ACTION-ITEMS.md).
> Retained because its ranked ideas for the edge/corner congregation problem —
> still unbuilt, still `NOTES.md` Tier 1 — exist nowhere else.
